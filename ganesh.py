...
def extract_json_from_response(response):
    ...
    if match:
        ...
        # 🧼 Fix invalid ",." after string closing
        raw_json = re.sub(r'"\s*\.,', '",', raw_json)  # Fix "., to ",
        raw_json = re.sub(r'",\s*([\]}])', r'\1', raw_json)  # Also clean up bad trailing commas
